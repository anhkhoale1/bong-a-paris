...
export function createApp({ pool, dataDirectory, seedData, authConfig } = {}) {
  ...
  app.use(
    "/api/auth",
    createAuthRoutes(createAuthController(authService), authenticate, {
  ...
  app.use(
    "/api/products",
    createProductRoutes(createProductController(productService)),
  );
  app.use(
    "/api/orders",
    createOrderRoutes(createOrderController(orderService)),
  );
  app.use(
    "/api/dashboard",
    createDashboardRoutes(
      createDashboardController(orderService, productService),
    ),
  );
